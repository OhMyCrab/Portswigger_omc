...
2. Truy cập trang web vào sản phẩm đầu tiên có hiển thị message Unfortunately this product is out of stock
...
- Hàm {{ os.popen("rm+/home/carlos/morale.txt").read() }}: os.popen(): mở một subprocess chạy lệnh shell. ; "rm+/home/carlos/morale.txt": lệnh xóa file /home/carlos/morale.txt.
